...
int main( int argc, char** argv )
{
    ...
    globalOptimizer.save("/Users/sofiawu/GitHub/rgbd-slam-test/data/VOData/result_before.g2o");
    globalOptimizer.initializeOptimization();
    globalOptimizer.optimize( 100 ); //可以指定优化步数
    globalOptimizer.save( "/Users/sofiawu/GitHub/rgbd-slam-test/data/VOData/result_after.g2o" );
    ...
    voxel.filter( *tmp );
    //存储
    pcl::io::savePCDFile( "/Users/sofiawu/GitHub/rgbd-slam-test/data/VOData/result.pcd", *tmp );
